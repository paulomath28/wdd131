...
document.querySelector("#old-button").addEventListener('click', () => {
  document.querySelector("#tab-title").textContent = "Old"
  let container = document.querySelector(".container")
  container.innerHTML = '';
...
document.querySelector("#new-button").addEventListener('click', () => {
  document.querySelector("#tab-title").textContent = "New"
  let container = document.querySelector(".container")
  container.innerHTML = '';
...
document.querySelector("#large-button").addEventListener('click', () => {
  document.querySelector("#tab-title").textContent = "Large"
  let container = document.querySelector(".container")
  container.innerHTML = '';
...
document.querySelector("#small-button").addEventListener('click', () => {
  document.querySelector("#tab-title").textContent = "Small"
  let container = document.querySelector(".container")
  container.innerHTML = '';
